...
public class TUGASP3 {
    ...
    public static void main(String[] args) {
        ...
        Integer pilihan = 0;
        int harga_item[] = {15000, 25000, 30000, 35000};
        String menu = null;
        int pembayaran;
        ...
        System.out.println("");
        System.out.println("-------------------------------------------------");
        System.out.println("-------------- SIXTY ONE COFFEE --------------");
        System.out.println("-------------------------------------------------");   
        System.out.println("| 1. Americano                |   Rp 12000      |");
        System.out.println("| 2. Arabika                  |   Rp 22000      |");
        System.out.println("| 3. Latte                    |   Rp 32000      |");
        System.out.println("| 4. Matcha                   |   Rp 42000      |");
